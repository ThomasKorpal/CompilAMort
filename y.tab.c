...
{
       0,    87,    87,    92,   100,   105,   111,   115,   122,   129,
     133,   137,   144,   148,   155,   159,   166,   173,   178,   184,
...
#line 101 "grammar.y"
        {
            (yyval.ptr) = make_node(NODE_LIST, 2, (yyvsp[0].ptr), NULL);
        }
#line 1465 "y.tab.c"
    break;
...
#line 326 "grammar.y"
        {
            (yyval.ptr) = make_node_bool_int(NODE_BOOLVAL, (yyvsp[0].intval));
        }
#line 1849 "y.tab.c"
    break;
